...
# end
 it("Prints out a list of numbers 1 through the input number, replacing number/s divisible by 3 with "ping", 
 replacing number/s divisible by 5 with "pong", and number/s divisible by both 3 and 5 with "ping-pong".") do
